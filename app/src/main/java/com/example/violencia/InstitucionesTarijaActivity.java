...
public class InstitucionesTarijaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_instituciones_tarija);
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    AdaptadorInstituciones adaptadorInstituciones= new AdaptadorInstituciones(InstitucionesTarijaActivity.this,institucionList);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(InstitucionesTarijaActivity.this, "ERROR", Toast.LENGTH_SHORT).show();
            }
        });
