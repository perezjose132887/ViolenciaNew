...
public class PublicacionesComunidadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_publicaciones_comunidad);

        recyclerView=findViewById(R.id.ReciclerDenuncias);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        publicacionList=new ArrayList<>();
        //listarComunidad("https://codeperez.000webhostapp.com/ListaPublicaciones.php");
        listarComunidad("https://luchacontralaviolencia.000webhostapp.com/ListaPublicaciones.php");
        //listarComunidad("http://192.168.1.103/violencia/ListaPublicaciones.php");

    }



    public void listarComunidad(String URL){
        StringRequest stringRequest=new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    AdaptadorPublicacionOficiales adaptadorPublicacionOficiales= new AdaptadorPublicacionOficiales(PublicacionesComunidadActivity.this,publicacionList);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(PublicacionesComunidadActivity.this, "ERROR", Toast.LENGTH_SHORT).show();
            }
        });
