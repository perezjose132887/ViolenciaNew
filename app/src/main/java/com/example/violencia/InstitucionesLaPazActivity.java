...
public class InstitucionesLaPazActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_instituciones_la_paz);
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    AdaptadorInstituciones adaptadorInstituciones= new AdaptadorInstituciones(InstitucionesLaPazActivity.this,institucionList);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(InstitucionesLaPazActivity.this, "ERROR", Toast.LENGTH_SHORT).show();
            }
        });
