...
public class InstitucionesPandoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_instituciones_pando);
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    AdaptadorInstituciones adaptadorInstituciones= new AdaptadorInstituciones(InstitucionesPandoActivity.this,institucionList);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(InstitucionesPandoActivity.this, "ERROR", Toast.LENGTH_SHORT).show();
            }
        });
