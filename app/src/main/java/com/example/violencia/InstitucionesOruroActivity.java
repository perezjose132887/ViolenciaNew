...
public class InstitucionesOruroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_instituciones_oruro);
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    AdaptadorInstituciones adaptadorInstituciones= new AdaptadorInstituciones(InstitucionesOruroActivity.this,institucionList);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(InstitucionesOruroActivity.this, "ERROR", Toast.LENGTH_SHORT).show();
            }
        });
