...
public class InstitucionesCochabambaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_instituciones_cochabamba);
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.GET, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    AdaptadorInstituciones adaptadorInstituciones= new AdaptadorInstituciones(InstitucionesCochabambaActivity.this,institucionList);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(InstitucionesCochabambaActivity.this, "ERROR", Toast.LENGTH_SHORT).show();
            }
        });
