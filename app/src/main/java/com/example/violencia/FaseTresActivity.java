...
public class FaseTresActivity extends AppCompatActivity {
    ...
    String Uno="1",Dos="2",Tres="3",sresult1,sresult2,sresult3,sresult4,sresult5,idUsuario,sresultadoFaseTres;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registrarFaseTres.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CalificarFaseTres();
                RegistrarTres("http://192.168.1.100/violencia/registrarFaseUno.php");
