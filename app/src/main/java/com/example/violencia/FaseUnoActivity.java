...
public class FaseUnoActivity extends AppCompatActivity {
    ...
    String Cero="0",Uno="1",Dos="2",sresult1,sresult2,sresult3,sresult4,sresult5,idUsuario,sresultadoFaseUno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registrarFaseUno.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CalificarFaseUno();
                //RegistrarUno("http://192.168.1.103/violencia/registrarFaseUno.php");
