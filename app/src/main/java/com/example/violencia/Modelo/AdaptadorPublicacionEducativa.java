...
public class AdaptadorPublicacionEducativa extends RecyclerView.Adapter<AdaptadorPublicacionEducativa.PlayerViewnHolder>{
    private Context mCtx;
    private List<ListaPublicaciones> publicacionOficialesList;

    public AdaptadorPublicacionEducativa(Context mCtx, List<ListaPublicaciones>publicacionOficialesList){
        this.mCtx=mCtx;
    ...
    @NonNull
    @Override
    public AdaptadorPublicacionEducativa.PlayerViewnHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater=LayoutInflater.from(mCtx);
        View view=inflater.inflate(R.layout.list_card,null);
        return new AdaptadorPublicacionEducativa.PlayerViewnHolder(view);
    }



    @Override
    public void onBindViewHolder(@NonNull AdaptadorPublicacionEducativa.PlayerViewnHolder holder, int position) {
