...
public class AdaptadorPublicacionActitudesIgualitarias extends RecyclerView.Adapter<AdaptadorPublicacionActitudesIgualitarias.PlayerViewnHolder>{
    private Context mCtx;
    private List<ListaPublicaciones> publicacionOficialesList;

    public AdaptadorPublicacionActitudesIgualitarias(Context mCtx, List<ListaPublicaciones>publicacionOficialesList){
        this.mCtx=mCtx;
    ...
    @NonNull
    @Override
    public AdaptadorPublicacionActitudesIgualitarias.PlayerViewnHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater=LayoutInflater.from(mCtx);
        View view=inflater.inflate(R.layout.list_card,null);
        return new AdaptadorPublicacionActitudesIgualitarias.PlayerViewnHolder(view);
    }



    @Override
    public void onBindViewHolder(@NonNull AdaptadorPublicacionActitudesIgualitarias.PlayerViewnHolder holder, int position) {
