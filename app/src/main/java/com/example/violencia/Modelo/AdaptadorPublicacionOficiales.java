...
public class AdaptadorPublicacionOficiales extends RecyclerView.Adapter<AdaptadorPublicacionOficiales.PlayerViewnHolder> {

    private Context mCtx;
    private List<ListaPublicaciones> publicacionOficialesList;

    public AdaptadorPublicacionOficiales(Context mCtx, List<ListaPublicaciones>publicacionOficialesList){
        this.mCtx=mCtx;
    ...
    public PlayerViewnHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AdaptadorPublicacionOficiales.PlayerViewnHolder(view);
    }
